...
def main():
    ...
    sales_file = uploads_dir / "sales_current.csv"
    rental_file = uploads_dir / "rentals_current.csv"
    ...
    try:
        ...
        with conn.cursor() as cur:
            ...
            logger.info(f"Data import completed: Sales: {sales_count}, Rentals: {rentals_count}")
